...
RLAPI void rlMultMatrixf2(float *matf);                // Multiply the current matrix by another matrix
...
// Multiply the current matrix by another matrix
void rlMultMatrixf2(float *matf)
{
    // Matrix creation from array
    Matrix mat = { matf[0], matf[4], matf[8], matf[12],
                   matf[1], matf[5], matf[9], matf[13],
    ...
    *currentMatrix = MatrixMultiply(mat, *currentMatrix);
}
